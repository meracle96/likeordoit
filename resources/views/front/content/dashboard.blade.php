                ...
                <ul><!-- SLIDE  -->
                    ...
                    <li data-index="rs-3050" data-transition="slideremovedown" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"    data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        ...
                        <div class="tp-caption title-slide"
                            ...
                            style="z-index: 16; white-space: nowrap;">Challenge Your Friends
                        </div>
                        ...
                        <div class="tp-caption sub-title"
                            ...
                            style="z-index: 17; white-space: nowrap;">Make Challenge For Your Friends and Share It To Everyone.
                        </div>
                    </li>
                   ...
                   <li data-index="rs-3051" data-transition="slideremovedown" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"    data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        ...
                        <!-- MAIN IMAGE -->
                        <img src="{{ asset('front/images/slides/2.jpg') }}"  alt=""  data-bgposition="center center" data-kenburns="off" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        <div class="tp-caption title-slide"
                            ...
                            style="z-index: 16; white-space: nowrap;">Beat The Challenge
                        </div>
                        ...
                        <div class="tp-caption sub-title"
                            ...
                            style="z-index: 17; white-space: nowrap;">Beat Challenge That Your Friend Make and Be The Real Challenge Warior.
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="title-section text-center">
                    ...
                    <div class="sub-title">
                        Find a challenge by their difficulty ?
                    </div>
                ...
                <div class="flat-client" data-item="4" data-nav="true" data-dots="false" data-auto="false">
                    <div class="client">
                        ...
                        <div class="content-client clearfix">
                            <div class="text">
                                <h3><a href="#" title="">Very Easy</a></h3>
                                <h5 style="color:white;">45 Challenges</h5>
                            </div>
                        </div>
                    </div>
                    <div class="client">
                    ...
                    <div class="client">
                        ...
                        <div class="content-client clearfix">
                            <div class="text">
                                <h3><a href="#" title="">Very Hard</a></h3>
                                <h5 style="color:white;">45 Challenges</h5>
                            </div>
                        </div>
                    </div>
...
<section class="flat-row section-product bg-theme">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="title-section text-center">
                    <h1 class="title">Recent Challenges</h1>
                    <div class="sub-title">
                      New Challenge For You. Dont Miss It.
                    </div>
                      ...
                      @endif
                        <div class="rate-product">
                            ...
                            <div class="info-product">
                              <form action="{{ route('front.like-button', ['slug' => $challenge->slug]) }}" method="post">
                                @csrf
                                <a href="#" class="heart" onclick="parentNode.submit();">
